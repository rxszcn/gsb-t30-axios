...
function resolveConfig(config) {
  ...
  // Params serialization can fail on circular structures or inside a
  // user-supplied serializer. Surface that as an AxiosError carrying the
  // request config, matching the envelope the http adapter produces for the
  // same failure, so callers get one consistent shape across adapters.
  try {
